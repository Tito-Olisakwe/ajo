...
contract CreateGroupsScript is Script {
    function run() external {
        ...
        group2Members[2] = 0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65; // member in both groups
        group2Members[3] = 0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc; // member in both groups
...
// forge script script/CreateGroups.s.sol --rpc-url "$ANVIL_RPC_URL" --broadcast
